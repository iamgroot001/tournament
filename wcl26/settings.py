"""
Django settings for wcl26 project.
Supports local development (SQLite) and production (Neon PostgreSQL via DATABASE_URL).
"""
...
WSGI_APPLICATION = 'wcl26.wsgi.application'


# Database
# Use DATABASE_URL env var for production (Neon PostgreSQL),
